...
public class MemberEnrollmentService {
	...
	public MemberEnrollmentService(MemberRepository memberRepository, InsurancePlanRepository planRepository) {
		this.memberRepository = memberRepository;
		this.planRepository = planRepository;
	}

	public MemberEntity enrollMember(Long payerOrgId, EnrollMemberRequest request) {
		InsurancePlanEntity plan = planRepository.findByPlanCodeAndPayerOrganization_Id(request.planCode(), payerOrgId)
